...
import { createMessage, hasCurrentClaim, identityOf, listTaskIds, mutateTask, openNodeOf, readState, readyNodes, undeliveredTo, withTaskLock, } from "./log.js";
...
export function installScheduler(ctx, config) {
    ...
    const kickLocked = async (workspace, stateRoot, taskId, suppliedLead) => {
    ...
    const runtime = {
        ...
        async kickTask(workspace, taskId, suppliedLead) {
            ...
            return withTaskLock(`kick ${stateRoot} ${taskId}`, () => kickLocked(workspace, stateRoot, taskId, suppliedLead));
        },
    };
