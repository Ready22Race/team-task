		...
		*/
		...
		function Panel({ sessionsList, openSession }) {
			...
			* the "newest unfinished" default until they pick something else. */
			const [pinnedTaskId, setPinnedTaskId] = (0, react.useState)();
			...
			(0, react.useEffect)(() => {
				const onOpen = (event) => {
					...
					if (requested !== void 0) setPinnedTaskId(requested);
					setMode("board");
				};
			...
			const task = (pinnedTaskId === void 0 ? void 0 : resolveTask(mine, pinnedTaskId)) ?? mine.find((t) => t.state.finishedAt === void 0) ?? mine.at(-1);
			(0, react.useEffect)(() => {
				if (task !== void 0 && task.state.id !== autoOpenedFor) {
					setAutoOpenedFor(task.state.id);
					if (pinnedTaskId === void 0) setMode("board");
								...
								(0, react_jsx_runtime.jsxs)("div", {
									...
									children: [
										...
										(0, react_jsx_runtime.jsxs)("div", {
											...
											children: [
												mine.length > 1 && (0, react_jsx_runtime.jsx)("button", {
													type: "button",
			...
			(0, react.useEffect)(() => {
				...
				const tick = async () => {
					try {
						...
						if (!response.ok) return;
						const body = await response.json();
						const found = Array.isArray(body.tasks) ? resolveTask(body.tasks, data.taskId) : void 0;
				...
				children: [
					...
					(0, react_jsx_runtime.jsxs)("footer", {
						...
						children: [(0, react_jsx_runtime.jsx)("span", {
							...
							onClick: () => {
								window.dispatchEvent(new CustomEvent(OPEN_BOARD_EVENT, { detail: { taskId: live?.state.id ?? data.taskId } }));
							},
							children: "看板 board"
						})]
					})
