...
export function Panel({ sessionsList, openSession }) {
    ...
    return (_jsx("div", { className: css.host, children: _jsxs("section", { className: css.panel, "data-team-task-board": true, children: [_jsxs("header", { className: css.head, children: [_jsxs("div", { className: css.headRow, children: [_jsx("div", { className: css.runIcon, children: "\u2301" }), _jsxs("div", { className: css.headTitles, children: [_jsx("div", { className: css.runName, title: task.state.goal, children: task.state.name }), _jsx("div", { className: css.runId, children: task.state.id })] }), _jsxs("div", { className: css.headActions, children: [_jsx("button", { type: "button", className: css.tiny, title: "\u6536\u8D77", onClick: () => setMode('pill'), children: "\u2014" }), _jsx("button", { type: "button", className: css.tiny, title: "\u5173\u95ED", onClick: () => setMode('hidden'), children: "\u00D7" })] })] }), _jsxs("div", { className: css.statusRow, children: [task.state.finishedAt !== undefined
